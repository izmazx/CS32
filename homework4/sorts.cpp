...
{
    //  Using the insertion sort algorithm (pp. 332-333 in the
...
void sortUsingPtrs(vector<Sensor>& sensors, bool comp(const Sensor*, const Sensor*))
{
    ...
    for (auto k = 0; k < auxSensors.size(); k++)
